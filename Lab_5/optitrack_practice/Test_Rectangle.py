...
positions = {}
rotations = {}
Destination = [[-4.1,3.3],[-4.1,-2.4],[0,-2.4],[0,0],[1.8,3.2],[-4.1,3.3]]
    ...
    try:
        while is_running:
            if robot_id in positions:
                ...
                Lis_X.append(xpos)
                Lis_Y.append(ypos)
                xdest=Destination[i][0]
                ydest=Destination[i][1]
                xdiff=xdest-xpos
                ydiff=ydest-ypos
...
for j in Destination:
    plt.plot(j[0], j[1], marker="o", markersize=5, markeredgecolor="red", markerfacecolor="red")
ax = plt.gca()
