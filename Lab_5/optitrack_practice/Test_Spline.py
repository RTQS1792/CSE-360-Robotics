...
plt.plot(Lis_X[0], Lis_Y[0], marker="o", markersize=5, markeredgecolor="red", markerfacecolor="red")
plt.plot(2, 2, marker="o", markersize=5, markeredgecolor="red", markerfacecolor="red")
ax = plt.gca()
